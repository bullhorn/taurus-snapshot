/**
 * /home/runner/work/taurus/taurus/LICENSE
 */
...
(function (FieldType) {
    ...
    FieldType["TO_ONE"] = "TO_ONE";
    FieldType["TO_MANY"] = "TO_MANY";
...
var localforage = createCommonjsModule$1(function (module, exports) {
/*!
...
class Staffing {
    constructor(options = {}) {
        ...
        this.config = Object.assign(Object.assign({}, this.config), this.options);
    ...
    static makeCall(callingIdentifier = '') {
        ...
        instance.interceptors.request.use((config) => {
            ...
            config.params.uniqueCallId = v4_1();
...
class MetaService {
     ...
     */
    params(object) {
        this.parameters = Object.assign(Object.assign({}, this.parameters), object);
        return this;
    }
    /**
    ...
    getFieldsAsRecord() {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.getFields()).reduce((obj, item) => {
                return Object.assign(Object.assign({}, obj), { [item.name]: item });
            }, {});
        });
    }
    getAllLayouts() {
    ...
    parse(result, keepFieldsFromLayout = false) {
        ...
        if (keepFieldsFromLayout) {
            ...
            const cacheResult = Object.assign(Object.assign({}, result), { fields: this.fields });
            // tslint:disable-next-line:no-floating-promises
...
class EntityService {
    ...
    edit(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const params = Object.assign(Object.assign({}, this.parameters), { layout });
...
class QueryService {
    ...
    appendQuery(value) {
        ...
        if (value === null || value === void 0 ? void 0 : value.length) {
            this.parameters.where = ((_a = this.parameters.where) === null || _a === void 0 ? void 0 : _a.length) ? `${this.parameters.where} AND ${value}` : value;
        }
        return this;
    }
    count(value) {
    ...
    run(add) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [response, metadata] = yield Promise.all([this.httpGet(this.parameters), this.meta.getFull(this.parameters.fields, this.parameters.layout)]);
            const result = response.data;
            if (this.shouldPullMoreRecords(result)) {
                const recursiveData = yield this.recursiveQueryPull(result);
    ...
    recursiveQueryPull({ count = 0, start = 0 }) {
        return __awaiter(this, void 0, void 0, function* () {
            const [nextStart, nextCount] = this.getNext(start, count);
            const response = yield this.httpGet(Object.assign(Object.assign({}, this.parameters), { start: nextStart, count: nextCount }));
            if (this.shouldPullMoreRecords(response.data)) {
                const nextData = yield this.recursiveQueryPull(response.data);
                response.data.data = response.data.data.concat(nextData);
            }
            return response.data.data;
        });
    }
    shouldPullMoreRecords({ count = 0, start = 0, total = 0 }) {
        const [nextStart, nextCount] = this.getNext(start, count);
...
var isFunction_1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
function isFunction(x) {
    return typeof x === 'function';
}
...
var hostReportError_1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
function hostReportError(err) {
    setTimeout(function () { throw err; });
}
...
var Observer = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var isArray$1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var UnsubscriptionError$1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
function UnsubscriptionErrorImpl(errors) {
    Error.call(this);
    this.message = errors ?
...
var Subscription_1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var Subscriber_1 = createCommonjsModule$1(function (module, exports) {
...
var canReportError_1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var toSubscriber_1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var noop_1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
function noop() { }
exports.noop = noop;
...
var pipe_1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var Observable_1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var isObservable_1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
class Entity extends StatefulSubject {
    ...
    patch(data, ignoreEvent = false) {
        ...
        const value = Object.assign(Object.assign({}, current), data);
        this.next(value);
        this.fields(Object.keys(value));
        if (!ignoreEvent) {
            this.broker.emit(`${this.type}:${value.id}:value`, value);
...
function observeListOptions(options, audit$$1 = true) {
    ...
    return new rxjs.Observable((observer) => {
        ...
        combined.subscribe(([fields, layout, meta, orderBy, startAt, limitTo, filter$$1, params, where]) => {
            const serializedOptions = {};
            if (fields !== undefined) {
                serializedOptions.fields = fields;
            }
...
class EntityList extends StatefulSubject {
    constructor(type, options = {}, state, callingIdentifier = '') {
        super(state);
        this.loadErrorSubject = new rxjs.Subject();
        this.broker = EntityMessageBroker.getInstance();
